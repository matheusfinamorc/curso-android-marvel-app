...
interface RepositoryModule {
    ...
    @Binds
    // quem precisar de CharactersRepository receberá injetado o CharactersRepositoryImpl
    fun bindCharacterRepository(repository: CharactersRepositoryImpl): CharactersRepository

    @Binds
    // quem depender de CharactersRemoteDataSource receberá injetado o RetrofitCharactersDataSource
